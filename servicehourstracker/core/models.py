...
class Event(models.Model):
    ...
    organizer = models.ForeignKey(OrgProfile, on_delete=models.CASCADE, related_name='events')
    approved = models.BooleanField(default=False)
    students = models.ManyToManyField(StudentProfile, through='Participation', related_name='events')
